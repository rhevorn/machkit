...
3. The user moves a compact reticle with a quieter magnifier and hex HUD,
   then drags a region framed by hairline corners; chrome lives in
   `ScreenshotSelectionChrome`. `ScreenshotGeometry` maps AppKit screen space
   to CGImage pixels.
