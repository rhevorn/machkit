 ...
 */
export type SplitWorkspaceProps = ComponentPropsWithoutRef<"div">;

export function SplitWorkspace({ className, children, ...props }: SplitWorkspaceProps) {
  return (
    <div
 ...
 */
export type EditorPaneProps = ComponentPropsWithoutRef<"section"> & {
  title?: ReactNode;
  actions?: ReactNode;
