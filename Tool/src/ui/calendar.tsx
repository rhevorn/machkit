  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-muted focus-visible:ring-3 focus-visible:ring-accent/35",
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:
          "grid size-8 place-items-center rounded-[6px] text-secondary outline-none hover:bg-muted hover:text-foreground focus-visible:ring-3 focus-visible:ring-accent/35",
        button_next:
          "grid size-8 place-items-center rounded-[6px] text-secondary outline-none hover:bg-muted hover:text-foreground focus-visible:ring-3 focus-visible:ring-accent/35",
