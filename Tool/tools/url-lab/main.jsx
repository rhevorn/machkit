...
function Seg({ children, className }) {
  return (
    <span
...
function AtomInput({ className, ...props }) {
  return (
    <Input
      spellCheck={false}
      className={cn(
...
function UrlLabTool() {
  ...
  function updateQuery(index, patch) {
        ...
        <div className="rounded-panel border border-border bg-surface px-3 py-2">
            <div className="flex flex-wrap items-center gap-x-0.5 gap-y-1">
              <AtomInput
                ...
                onChange={(event) => updatePart("protocol", event.target.value)}
              />
              <Seg>://</Seg>
              <AtomInput
                ...
                onChange={(event) => updatePart("hostname", event.target.value)}
              ...
              <AtomInput
                ...
                className="w-[4.5rem]"
                value={parts.port || ""}
                onChange={(event) => updatePart("port", event.target.value)}
                placeholder="443"
              />
            </div>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-0.5 gap-y-1 border-t border-border/50 pt-1">
              <AtomInput
                ...
                onChange={(event) => updatePart("username", event.target.value)}
              ...
              <AtomInput
                ...
                onChange={(event) => updatePart("password", event.target.value)}
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-0.5 gap-y-1 border-t border-border/50 pt-1">
              ...
              <AtomInput
                ...
                value={parts.hash || ""}
                onChange={(event) => updatePart("hash", event.target.value.replace(/^#/, ""))}
                placeholder="hash"
              />
            </div>
        </div>
